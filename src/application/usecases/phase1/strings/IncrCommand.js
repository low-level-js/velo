/**
 * IncrCommand.js
 * Comando INCR — incrementa el valor entero de una clave en 1.
 * Si la clave no existe, se inicializa en 0 antes de incrementar.
 *
 * Sintaxis: INCR clave
...
export class IncrCommand {
  static get nombre() { return 'INCR'; }
  ...
  execute(store, args, db) {
    if (args.length !== 1) {
      return { err: 'ERR numero de argumentos incorrecto para el comando INCR' };
    }
